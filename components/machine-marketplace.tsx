...
export function MachineMarketplace() {
  ...
  const machines: MachineType[] = [
    {
      ...
      price: 2500, // 2,500 XAF
      daily_earning_rate: 900, // 900 daily earnings
      monthly_earning: 27000, // 27,000 monthly
      description:
    ...
    },
    {
      ...
      daily_earning_rate: 1650, // 1,650 daily earnings
      monthly_earning: 49500, // 49,500 monthly
      description:
    ...
    },
    {
      ...
      price: 10000, // 10,000 XAF
      daily_earning_rate: 3500, // 3,500 daily earnings
      monthly_earning: 105000, // 105,000 monthly
      description:
    ...
    },
    {
      ...
      daily_earning_rate: 5000, // 5,000 daily earnings
      monthly_earning: 150000, // 150,000 monthly
      description:
    ...
    },
    {
      ...
      price: 25000, // 25,000 XAF
      daily_earning_rate: 8333, // 8,333 daily earnings
      monthly_earning: 250000, // 250,000 monthly
      description:
    ...
    },
    {
      ...
      daily_earning_rate: 16666, // 16,666 daily earnings
      monthly_earning: 500000, // 500,000 monthly
      description:
    ...
    },
    {
      ...
      price: 100000, // 100,000 XAF
      daily_earning_rate: 33333, // Coming soon
      monthly_earning: 1000000, // Coming soon
      description:
    ...
    },
    {
      ...
      price: 150000, // 150,000 XAF
      daily_earning_rate: 50000, // Coming soon
      monthly_earning: 1500000, // Coming soon
      description:
  ...
  const handlePurchase = async (machineId: string) => {
    ...
    const userBalanceXAF = (user.wallet_balance ?? 0) * 600 // Convert USD to XAF
          ...
          {machines.map((machine, index) => (
            ...
            >
              ...
              <CardContent className="space-y-5">
                {/* Machine Image */}
                <div
                  className={`aspect-square bg-gradient-to-br ${machine.gradient} rounded-xl flex items-center justify-center relative overflow-hidden shadow-lg`}
                >
                  <div className="absolute inset-0 bg-black/10"></div>
                  <img
                    src={`/placeholder.svg?height=400&width=400&query=${encodeURIComponent(machine.image_query)}`}
                    alt={machine.name}
                ...
                <div className="space-y-4">
                  ...
                  <Button
                    ...
                    disabled={
                      ...
                      (user?.wallet_balance ?? 0) * 600 < machine.price
                    }
                  ...
                  {(user?.wallet_balance ?? 0) * 600 < machine.price && machine.is_available && (
