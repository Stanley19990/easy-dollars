...
import { Wallet, DollarSign, Coins, TrendingUp, Plus, Info } from "lucide-react"
        ...
        <CardContent>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-lg p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  ...
                  className="bg-green-500/20 border border-green-500/30 text-green-300 hover:bg-green-500/30 hover:text-green-200"
                >
                  <Plus className="h-4 w-4 mr-1" />
                  Deposit
                </Button>
              </div>
              <div className="text-3xl font-bold text-green-400 mb-2">${(user.wallet_balance ?? 0).toFixed(2)}</div>
              <p className="text-xs text-green-200/70">Available for machine purchases and withdrawals</p>
            </div>
          ...
          <div className="mt-6 bg-slate-800/30 rounded-lg p-4">
            ...
            <div className="space-y-2 text-xs text-slate-300">
              <p>
                <strong className="text-green-400">USD Balance:</strong> Real money for purchasing machines and
                withdrawals
              </p>
              <p>
              ...
              <p>
                <strong className="text-amber-400">Deposits:</strong> Add funds via MTN, Orange Money, or PayPal
              </p>
              <p>
